...
<footer class="container py-5">
  <div class="row">
    ...
    <div class="col-6 col-md">
      <h5>About</h5>
      <ul class="list-unstyled text-small">
        <li><a class="text-muted" href="#"><GoMarkGithub size={50} /></a></li>
        <li><a class="text-muted" href="#"><FaTwitter size={50} /></a></li>
        <li><a class="text-muted" href="#"><FaInstagram size={50} /></a></li>
        <li><a class="text-muted" href="#"><FaFacebookSquare size={50} /></a></li>
      </ul>
    </div>
  </div>
</footer>
